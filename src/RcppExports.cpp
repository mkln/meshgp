...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type setseed(setseedSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_meshgp_qmeshgp_svc_mcmc", (DL_FUNC) &_meshgp_qmeshgp_svc_mcmc, 36},
    {NULL, NULL, 0}
};
